    ...
    <section style={{ background: '#100C08', fontFamily: 'var(--font-display)' }}>
      <div className="mx-auto max-w-screen-xl px-5 sm:px-8 md:px-14 lg:px-20 py-16 md:py-28">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[5fr_7fr] gap-12 md:gap-16 lg:gap-0"
          style={{ borderTop: '1px solid rgba(245,237,216,0.07)', paddingTop: '2.5rem' }}>

          {/* Left — positioning */}
          <div className="flex flex-col justify-between lg:pr-16 lg:border-r"
            ...
            <div>
              ...
              <h2 className="font-black uppercase leading-[0.95] mb-6 md:mb-8"
                style={{ color: '#F5EDD8', fontSize: 'clamp(1.6rem,5vw,4rem)', letterSpacing: '-0.03em' }}>
                Від лісу<br />до готового<br />матеріалу
              </h2>
              <p style={{ color: 'rgba(245,237,216,0.5)', fontSize: '0.92rem', lineHeight: 1.65 }} className="md:max-w-[36ch]">
          ...
          <div className="grid grid-cols-2 lg:pl-16">
            {STATS.map(({ num, label }, i) => (
              <div key={label}
                ...
                <div className="font-black tabular-nums leading-none mb-2 break-words"
                  style={{ color: '#F5EDD8', fontSize: 'clamp(1.4rem,4vw,4rem)', letterSpacing: '-0.04em', whiteSpace: 'pre-line' }}>
                  {num}
                </div>
